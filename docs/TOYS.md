...
|---|:---:|---|
| Ambient | – | Home base. One of 10 backgrounds: digital or analog clock, connection, battery %, download speed, tilt ball, pixel clock, battery gauge, solar path, moon phase. A charge layer and a music layer draw on top, and night and shake-to-show gating keep it quiet when you want. |
...
| Rock Paper Scissors | ✅ | A "SET" banner, a shaking 3-2-1, then fist, flat hand or scissors, held until the next press. No opponent — you throw with your real hand. |
